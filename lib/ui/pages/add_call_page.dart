                  ...
                  child: Obx(
                    () => Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        text('Short Order *', Colors.white, 18,
                            FontWeight.normal),
                        inputField(
                        ...
                        Padding(
                          ...
                          child: DropdownButtonFormField(
                            ...
                            decoration: drpdownFieldDecoration(),
                            onChanged: (newValue) {
                              print(
                            ...
                            validator: controller.isEmptyValid,
                        ...
                        SizedBox(height: 10),
                        text('Company Name ', Colors.white, 18,
                            FontWeight.normal),
                        inputField(
                        ...
                        SizedBox(height: 10),
                        SizedBox(height: 10),
                        text('Reference By', Colors.white, 18,
                            FontWeight.normal),
                        inputField(
                        ...
                        SizedBox(height: 10),
                        text(
                            'Short Brief', Colors.white, 18, FontWeight.normal),
                        inputField(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: DropdownButton(
                              isExpanded: true,
                              padding: EdgeInsets.fromLTRB(12, 2, 10, 1),
